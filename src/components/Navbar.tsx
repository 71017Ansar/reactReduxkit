      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex items-center gap-2">
          <button
            type="button"
            onClick={() => {
              setShowWishlistDetails((value) => !value)
          ...
          <button
            type="button"
            onClick={() => {
              setShowCartDetails((value) => !value)
          ...
          {showWishlistDetails && (
            <div className="absolute right-0 top-12 mt-2 w-96 rounded-xl border border-slate-200 bg-white p-4 shadow-xl">
